const About = () => {
  return (
    <div className="bg-linear-to-br from-[#030712] to-[#131830]">
        <div className=" py-20 px-40 flex flex-col space-y-10 items-center justify-start">
            ...
            <span className="mb-18"><p className="text-xl text-gray-300 px-150 text-center">We provide internships through structured courses and real project submissions — so students gain real experience while they learn.</p></span>
            <span className="flex flex-col items-start justify-start px-100 mb-18">
            ...
            <span className="w-full px-100 mb-18">
            ...
            <span className="w-full flex flex-col items-start justify-start px-100 mb-18">
